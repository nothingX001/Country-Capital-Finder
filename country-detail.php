...
<head>
    ...
    <title><?php echo htmlspecialchars($country['country_name']); ?> Profile</title>
...
<body>
    ...
    <section id="country-profile">
        ...
        <p>Flag: <?php echo htmlspecialchars($country['flag_emoji']); ?></p>
        <p>Capital: <?php echo htmlspecialchars($country['capital_name']); ?></p>
        ...
        <img src="<?php echo htmlspecialchars($country['map_image_url'] ?? 'placeholder.jpg'); ?>" alt="Map of <?php echo htmlspecialchars($country['country_name']); ?>" style="width:100%; height:auto;">
    </section>
</body>
</html>
