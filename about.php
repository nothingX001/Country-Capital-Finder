...
<head>
    ...
    <meta name="description" content="ExploreCapitals is a unique application where you can find any country’s capital. Take an interactive quiz and test your geography knowledge with ease. Perfect for geography bees and learners.">
    ...
    <meta property="og:title" content="ExploreCapitals | Interactive Country Capital Quiz">
    ...
    <meta property="og:url" content="https://www.explorecapitals.com/">
    <meta property="og:image" content="https://www.yoursite.com/images/country-capital-quiz.png">
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="ExploreCapitals">
...
<body>
    ...
    <section class="about-section">
        ...
        <p>Welcome to <strong>ExploreCapitals.com</strong>—an intuitive application where you can <strong>find any country’s capital</strong> with ease. Created to support learners of all levels, from students to trivia enthusiasts, our platform offers an <strong>interactive capital quiz</strong> and an extensive <strong>capitals of the world quiz</strong> designed to make memorizing capitals both engaging and effective. Ideal for <strong>geography bee prep</strong>, this tool is perfect for anyone looking to improve their knowledge of world geography.</p>
        <h2>Social Media</h2>
            <ul>
